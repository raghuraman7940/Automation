...
public class ValidationUtils {
    ...
    public static String validateJson(JsonSchema jsonSchemaNode, JsonNode jsonNode)throws ProcessingException 
    {
        ...
        if (!report.isSuccess()) {
            for (ProcessingMessage processingMessage : report) {
            	...
            	ProcMsg=ProcMsg+" \n "+processingMessage.getMessage();
            	 System.out.println("Report Value : "+processingMessage.getMessage());
            	 System.out.println("Report Value Des : "+processingMessage.toString());
            }
            //return ProcMsg;
        }
        return ProcMsg;
    ...
    public static String validateJson(String schemaText, String jsonText) throws IOException, ProcessingException{
        final JsonSchema schemaNode = getSchemaNode(schemaText);
        final JsonNode jsonNode = getJsonNode(jsonText);
        
        String  ProcMsg=validateJson(schemaNode, jsonNode);
        return ProcMsg;
    ...
    public static String validateJson(URL schemaDocument, URL jsonDocument) throws IOException, ProcessingException{
    ...
    public static String validateJsonResource(String schemaResource, String jsonResource) throws IOException, ProcessingException{
